...
navcollapse.click(function (e) {
    // Stop click event if it's a child element (avoid conflict)
    if ($(e.target).closest('.dropdown-btn').length === 0) {
        if ($(window).innerWidth() >= mobileWidth) {
            ...
            var icon = $(this).find('.dropdown-btn div');
...
if ($('.main-header .navigation li.dropdown ul').length) {
    ...
    // Dropdown Button
    $('.main-header .navigation li.dropdown .dropdown-btn').on('click', function (e) {
        e.preventDefault(); // Prevent default anchor behavior
        var dropdown = $(this).prev('ul');
        var megamenu = $(this).prev('.megamenu');

        // Toggle the dropdown menu and megamenu
        dropdown.slideToggle(500);
        megamenu.slideToggle(800);
    ...
    $('.navigation li.dropdown > a').on('click', function (e) {
        ...
        if ($('.menu-sidebar').length) {
            ...
            $('.menu-sidebar').on('click', function(e) {
                ...
                $('#mobileSidebar').toggleClass('open');  // Show the sidebar
            });
        
            // Hide Sidebar (Cross Icon, Background, Close Button)
            $('.hidden-bar .inner-box .cross-icon, .form-back-drop, .close-menu').on('click', function(e) {
                e.preventDefault();
                $('body').removeClass('side-content-visible');
                $('#mobileSidebar').removeClass('open');  // Hide the sidebar
            });
        
            // Also add the cross icon functionality to close the sidebar
            $('#mobileSidebar .cross-icon').on('click', function(e) {
                e.preventDefault();
                $('body').removeClass('side-content-visible');
                $('#mobileSidebar').removeClass('open');
            });
        
            // Dropdown Menu for Sidebar Navigation
            $('#mobileSidebar .dropdown > a').on('click', function(e) {
                e.preventDefault();
                $(this).next('ul').slideToggle(300);  // Smooth slide down
                $(this).parent().toggleClass('open');  // Toggle open class for dropdown visibility
            });
        }
...
$(document).ready(function() {
    $('.gallery-two-item .link').magnificPopup({
        type: 'image',
        gallery: {
            enabled: true,
